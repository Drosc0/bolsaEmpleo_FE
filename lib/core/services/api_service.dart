...
class ApiService {
  ...
  // Función privada para el manejo centralizado de errores HTTP
  ...
  // 2. GET (Para obtener ofertas y estadísticas)
  ...
  // 3. PUT (Para actualizar recursos)
